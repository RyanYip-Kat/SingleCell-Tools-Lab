...
object<-subset(object,idents=c("1","7","3","24","8","10","19"))
...
genes<-c("GZMK", "GZMB", "GNLY", "ITGB1","PIM1", "IRF1","IRF7","IFITM2","DUSP1","DUSP2","IRAK1", "PSMB8","PSME1","S100A8","S100A9","FOS","JUN")
...
DotPlot(object,features=genes,dot.scale=10)+my_theme
dev.off()
