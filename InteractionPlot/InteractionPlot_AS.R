...
bc<-readRDS("../20200409/output/aging-xxx/BC/model/seurat.rds")
tc<-readRDS("../20200418/output/aging-xxx/TC/model/seurat.rds")
mono<-readRDS("../20200410/output/aging-xxx/Mono/model/seurat.rds")
...
seurat<-subset(seurat,idents="AS")
