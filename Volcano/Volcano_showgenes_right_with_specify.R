...
####
show_genes<-c("DUSP1","VIM","IL32","PSME1","CLIC1","CRIP1","ISG20",
              "S100A4","S100A10","TXN","ZFP36","CALR","CXCR4","DDIT4","CD69","CASP4", 
              "PSMB8","PSMB9","PSME1", "ANXA1","BSG","PIM1","CTSA","TXN","CISH")
###
markers<-read.csv("../20200420/output/aging-xxx/Status-Markers/TC/CD4/AS_YS_markers.csv",stringsAsFactors=FALSE)
...
label<-with(markers,ifelse(logFC < -0.75,
