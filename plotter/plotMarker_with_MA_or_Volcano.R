...
plotMarkers(seMarker,name="Limbus",cutOff="FDR <= 0.01 & abs(Log2FC) >= 0.5",plotAs="Volcano")
plotMarkers(seMarker,name="Limbus",cutOff="FDR <= 0.01 & abs(Log2FC) >= 0.5",plotAs="MA")
