...
def filter_fasta(fasta,pattern="N",outdir="./outdir"):
...
if __name__=="__main__":
    parser = argparse.ArgumentParser(description="Program to extract sequence from fasta file")
