...
if __name__=="__main__":
    ...
    parser.add_argument("--barcode",type=str,default=None,help="barcode for subset,csv file")
    ...
    print("# Loading barcode for subset from : {}".format(args.barcode))
    df=pd.read_csv(args.barcode)
    cells=df.iloc[:,0].values.tolist()
    adata=subset_by_cell_feature(adata,cells=cells,invert=False)
