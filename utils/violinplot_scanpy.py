...
parser.add_argument("--groupby_level",nargs="+",type=str,default=None,help="")
...
if args.groupby_level is not None:
    adata.obs[args.groupby]=adata.obs[args.groupby].cat.reorder_categories(args.groupby_level)
for gene in genes:
        sc.pl.violin(adata,gene,groupby=args.groupby,show=False,save="_"+gene+"_"+args.groupby+".pdf")
